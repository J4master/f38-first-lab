...
console.log(`My internet speed is ${speed}`)
...
console.log(`My Netflix subscription is ${netflix}`)
console.log(`My hulu subscription is ${hulu}`)
console.log(`My Disney+ subscription is ${disneyPlus}`)
console.log(`My YouTube Premium subscription is ${youtubePrem}`)
console.log(`My Peacock subscription is ${peacock}`)
...
// CODE HERE
total = netflix + hulu + disneyPlus + youtubePrem + peacock

console.log(`The total amount of my subscriptions cost ${total}`)
...
console.log(`My Peacock subscription is now ${peacock}`)
console.log(`My Netflix subscription is now ${netflix}`)
console.log(`My hulu subscription is now ${hulu}`)
